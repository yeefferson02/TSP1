...
--
-- Host: localhost
-- Generation Time: Apr 07, 2012 at 04:04 AM
...
CREATE TABLE IF NOT EXISTS `char` (
  ...
  KEY `name` (`name`),
  KEY `online` (`online`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=150000 ;
...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `know` int(11) NOT NULL COMMENT 'where did you hear about puff RO',
...
INSERT INTO `login` (`account_id`, `userid`, `user_pass`, `sex`, `email`, `group_id`, `state`, `unban_time`, `expiration_time`, `logincount`, `lastlogin`, `last_ip`, `birthdate`, `credits`, `last_vote_gtop`, `last_vote_xtreme`, `last_vote_gamesites`, `premium`, `name`, `know`) VALUES
(1, 's1', 'p1', 'S', 'athena@athena.com', 0, 0, 0, 0, 0, '0000-00-00 00:00:00', '', '0000-00-00', 0, 0, 0, 0, 0, 0, 0),
(2000000, 'sample12345', 'edcc21dc21a00842a4c3509b844ddeb3', 'M', 'asdfas@yahoo.com', 0, 0, 0, 0, 0, '0000-00-00 00:00:00', '', '0000-00-00', 0, 0, 0, 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `news_updates` (
  `news_ups_id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `type` varchar(25) NOT NULL,
  `news_updates` varchar(25000) NOT NULL,
  `date` varchar(255) NOT NULL,
  PRIMARY KEY (`news_ups_id`)
...
INSERT INTO `vote_ip` (`vote_id`, `account_id`, `ip_address`, `next_vote_gtop`, `next_vote_xtreme`, `next_vote_gamesites`) VALUES
(316, 2001110, '::1', 1333562972, 1333562975, 1333562980),
(317, 2001111, '::1', 1333562972, 1333562975, 1333562980),
(318, 2000000, '::1', 0, 0, 0);
